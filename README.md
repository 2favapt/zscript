...
- [Privilege escalation](#Privilege-escalation)
  ...
  - [Loot](#Loot)
    ...
    - [Windows](#Windows)
      ...
      - [Interesting files](#Interesting-files)
    - [Cloud](#Cloud)
      - [pentest-ec2-manager](#pentest-ec2-manager)
...
> https://blog.stealthbits.com/extracting-service-account-passwords-with-kerberoasting/ > https://www.youtube.com/watch?v=snGeZlDQL2Q > https://www.tarlogic.com/blog/como-funciona-kerberos/ > https://www.tarlogic.com/blog/como-atacar-kerberos/
...
[_https://github.com/erik1o6/oscp/blob/master/wget-vbs-win.txt_](https://github.com/erik1o6/oscp/blob/master/wget-vbs-win.txt)
...
Those scripts are useful for managing _single_ EC2 instance, which is picked based on specific characteristics: `key-name`, `image-id`, `security-group-name`, `instance-type`.
